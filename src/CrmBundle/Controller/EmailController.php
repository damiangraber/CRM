...
class EmailController extends Controller {
    ...
    public function indexAction() {
        ...
        $emails = $em->getRepository('CrmBundle:Email')->findAll();

        return $this->render('CrmBundle:Email:index.html.twig', array(
            'emails' => $emails,
        ));
    }
    ...
    public function newAction(Request $request) {
        $email = new Email();
        $form = $this->createForm('CrmBundle\Form\EmailType', $email);
        ...
        return $this->render('CrmBundle:Email:new.html.twig', array(
            'email' => $email,
    ...
    public function showAction(Email $email) {
        ...
        return $this->render('CrmBundle:Email:show.html.twig', array(
            'email'       => $email,
    ...
    public function editAction(Request $request, Email $email) {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('CrmBundle\Form\EmailType', $email);
        ...
        return $this->render('CrmBundle:Email:edit.html.twig', array(
            'email'       => $email,
